            ...
            <div class="row">
              ...
              <div class="col-lg-3">
                 <?= $form->field($model, 'trans_type')->widget(Select2::className(),[
                    'data'=> ArrayHelper::map(\backend\helpers\TransactionType2::asArrayObject(),'id','name'),
                                ...
                                <?php foreach($model_line as $value):?>
                                  ...
                                  <tr class="saleline-id-">
                                    ...
                                    <td>
                                     ...
                                     <?php
                                        $select = '';
                                        if($value->title_id == $data[$i]['id']){
                                          $select = "selected";
                                        }
                                      ?>
                                     <option value="<?=$data[$i]['id']?>" <?=$select?>><?=$data[$i]['name']?></option>
                                     <?php endfor; ?>
                                   </select>
...
<?php
    $url_to_add_line = Url::to(['income/addline'],true);
