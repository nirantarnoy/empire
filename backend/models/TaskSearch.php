...
class TaskSearch extends Task
{
    ...
    {
        return [
            [['id', 'task_interval', 'task_start_date', 'task_next_date', 'task_last_date', 'emp_id', 'status', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'task_last_date' => $this->task_last_date,
            'emp_id' => $this->emp_id,
            'status' => $this->status,
